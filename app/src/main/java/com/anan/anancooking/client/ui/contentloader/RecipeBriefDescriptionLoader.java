...
public class RecipeBriefDescriptionLoader extends AsyncTask<Long, Void, RecipeInterface> {
    ...
    protected RecipeInterface doInBackground(Long... recipeIDs) {
        ...
        Drawable drawable = parentActivity.getResources()
                .getDrawable(parentActivity.getResources().getIdentifier("fried_rice_finished", "drawable", parentActivity.getPackageName()));
        recipe.setPreview((BitmapDrawable) drawable);
        return recipe;
    ...
    protected void onPostExecute(RecipeInterface recipe) {
        ...
        previewImage.setImageDrawable(recipe.getPreview());
